...
public class GLImageEffectShakeFilter extends GLImageEffectFilter {
    ...
    public GLImageEffectShakeFilter(Context context) {
        this(context,VERTEX_SHADER, FileUtils.getShaderFromAssets(context, "shader/effect/fragment_effect_shake.glsl"));
    }

    public GLImageEffectShakeFilter(Context context, String vertexShader, String fragmentShader) {
