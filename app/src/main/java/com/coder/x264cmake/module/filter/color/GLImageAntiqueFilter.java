...
public class GLImageAntiqueFilter extends GLImageBaseFilter {
    ...
    public GLImageAntiqueFilter(Context context) {
        this(context, VERTEX_SHADER, FileUtils.getShaderFromAssets(context, "shader/color/fragment_antique.glsl"));
    }

    public GLImageAntiqueFilter(Context context, String vertexShader, String fragmentShader) {
...
//        setFloat(mStrengthUniformLoc, mStrength);
    ...
    private void loadTextures() {
        mCurveTexture = OpenGlUtils.loadTexture(FileUtils.getImageFromAssetsFile(mContext,
                "filter/color/antique/curve.png"));
    }
