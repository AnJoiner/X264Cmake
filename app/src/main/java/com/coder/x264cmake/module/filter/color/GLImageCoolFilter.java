...
public class GLImageCoolFilter extends GLImageBaseFilter {
    ...
    public GLImageCoolFilter(Context context) {
        this(context, VERTEX_SHADER, FileUtils.getShaderFromAssets(context, "shader/color/fragment_cool.glsl"));
    }
    ...
    private void loadTextures() {
        mCurveTexture = OpenGlUtils.loadTexture(FileUtils.getImageFromAssetsFile(mContext,
                "filter/color/cool/cool_curve.png"));
    }
